...
Here, we're asking R to give us a box plots of heights where 
...
from a lab written by Mark Hansen of UCLA Statistics. Additionally, this lab was adapted using functions 
in the `mosaic` and `ggformula` packages by Nicholas Horton and Bonnie Lin of Amherst College Department of Statistics.
</div>
