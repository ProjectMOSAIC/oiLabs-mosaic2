...
correlation printed in the upper triangle..

XX NH Can you help me understand how to interpret the density plots on the diagonal? 

As one can see from the scatterplots, these variables are collinear (correlated), and 
