...
6.  Use residual plots to evaluate whether the conditions of least squares
    ...
    a template for your work (hint: change the variable `m1` and data names before running)
...
gf_point(residuals ~ fitted.values, data = m1) %>%
  gf_hline(yintercept = 0, linetype = "dashed") 
...
gf_point(bty_avg ~ bty_f1lower, data = evals, 
         xlab = "Beauty Rating of Professor from First or Second Year Female", ylab = "Avg Beauty Rating")
