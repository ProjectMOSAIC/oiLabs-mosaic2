...
These data points overlap in the scatter plot and make it hard to get a sense of the overall density. 
...
```{r bty-rel}
gf_point(bty_avg ~ bty_f1lower, data = evals, xlab = "Beauty Rating of Professor from Lower Level Female", ylab = "Avg Beauty Rating")
