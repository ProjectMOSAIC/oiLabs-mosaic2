...
If we wish to plot lines instead of points, we can change the `plottype` in the {ggformula} function that you type. `plottype` describes the type of plot desired (points, lines, a histogram, etc.)
...
XX installing packages `cdc` data error still present 

```{r load-mosaic-devtools-oilabs, message=FALSE, eval=FALSE}
